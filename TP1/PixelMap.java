...
public class PixelMap 
{
	...
	protected void AllocateMemory(ImageType type, int h, int w)
	{
		...
		// compléter
			...
			/*switch(type) {
				...
				break;
				case Gray: 	imageData =  new GrayPixel[h][w];
				
				break;
				case Color:		imageData =  new ColorPixel[h][w];
					
				break;
				case Transparent: 	imageData =  new TransparentPixel[h][w];
	...
	void readFromFile(String fileName) throws IOException
	{
		...
		if( header.equals( "P1" ) ){
			...
			throw new IOException(fileName + " : ne contient pas le bon entÃªte");
